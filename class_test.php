...
<!--start middle part -->
   ...
   <div class="rightclm" style="height:250px;">
          <div class="acco" style="margin-left:-25px;">
           <div class="filez">
            <p><img src="icon/page_written.ico" style="padding-right:10px;" />Please upload Your picture</p>
            <table width="600" border="0">
             <form id="imageform" method="post" enctype="multipart/form-data" action='exam_class_test.php'>
  <tr>
    <input type="hidden" name="pic_name" value="<?php echo $row['teacher_name']; ?>" />
    <td>Select Class</td>
    <td>&nbsp;</td>
     <?php
...
FROM `class`";
  ...
  <tr>
    <td width="195">Select Your CSV File</td>
    <td width="14">&nbsp;</td>
    <td width="377">
      <span id="pimg">
