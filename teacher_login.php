...
<div class="main_container">
  ...
  <div class="container">
       ...
       <ul>
     <li style="width:1000px;"> <b>Welcome to Busy Bees International School</b> <br />
     <h3 style="font-family:Arial, Helvetica, sans-serif; font-weight:100; color:#003; font-weight:bold">This area only for Teacher Login<br /> 
      </h3>
  ...
  <tr>
    <td width="285"><b>Teacher's Email</b></td>
  ...
  <tr>
    <td><br /><b>Teacher's Password</b></td>
  </tr>
  <tr>
...
<script>
 ...
 $("#subm").click(function () {
  ...
  $.post('teacher_login_pass.php',{num:num, num2:num2},function(check){
	   
				 if (check == 'email_error'){
					 $('#result').text("Loading...");
                    $('#result').text("wrong username and password");
                }if (check == 'success'){
                    window.location.href = "http://localhost/school/teacher.php";
                }
