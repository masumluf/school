   ...
   <div class="middle">
      ...
      <div class="rightclm">
           ...
           <div class="filez" style="background-color:#FCFCFC; padding:10px; font-family:Tahoma, Geneva, sans-serif; font-size:12px; margin-left:-25px;">
            ...
            <ul>
               <li style="list-style:url(icon/image_new.gif)"><a href="teacher_pic_change.php">Change Picture</a></li>
               <li style="list-style:url(icon/megaphone.ico)"> <a href="notice.php?lightbox[width]=800&lightbox[height]=320" class="lightbox">Notice</a></li>
               <li style="list-style:url(icon/list_keys.gif)"><a href="teacher_pass_change.php?lightbox[width]=800&lightbox[height]=320" class="lightbox">Password Change</a></li>
               
               <li style="list-style:url(icon/icon_security.gif)"><a href="edit.php">Edit Information</a></li>
