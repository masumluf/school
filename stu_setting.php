...
<!--start middle part -->
   ...
   <div class="middle">
      <div class="leftclm">
            ...
            <ul>
               <li><a href="student.php">HOME</a></li>
                 ...
                 <li><a href="teacher.php">SETTING</a></li>
    ...
    <dt class="current">Security</dt>
    <dd class="current">
      <h2 style="color:#993300">Change Password</h2>
      <p>
...
<table width="600" border="0">
  <tr>
    ...
    <td width="8">:</td>
    <td width="378"><input type="password" name="old" id="old" required="required" style="width:300px; height:15px;" /></td>
  </tr>
  <tr>
 ...
 $("#pro").click(function () {
  ...
  $.post('change_password.php',{num:num, num2:num2, num3:num3},function(check){
                    $('#error').html(check);
